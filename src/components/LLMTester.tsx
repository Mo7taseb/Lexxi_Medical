    ...
    return (
        <div className="max-w-4xl mx-auto p-4 sm:p-6 space-y-4 sm:space-y-6">
            <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6">
                <h2 className="text-xl sm:text-2xl font-bold mb-4 text-gray-800">🧪 LLM Integration Tester</h2>
                ...
                {/* Test Configuration - Mobile responsive */}
                ...
                {enhancementResult && (
                    <div className="mb-6 p-4 bg-blue-50 rounded-lg">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-4 mb-3 text-sm text-gray-700">
                            <div>
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="mt-3 w-full sm:w-auto bg-purple-500 text-white px-4 py-2 rounded hover:bg-purple-600 disabled:opacity-50"
                        >
